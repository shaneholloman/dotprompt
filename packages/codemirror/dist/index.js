...
__export(index_exports, {
  dotprompt: () => dotprompt,
  dotpromptCompletions: () => dotpromptCompletions,
  dotpromptDarkHighlighting: () => dotpromptDarkHighlighting,
  dotpromptDarkTheme: () => dotpromptDarkTheme,
  dotpromptLanguage: () => dotpromptLanguage,
  dotpromptLightHighlighting: () => dotpromptLightHighlighting,
  dotpromptLightTheme: () => dotpromptLightTheme,
  dotpromptStreamParser: () => dotpromptStreamParser
});
...
var dotpromptLanguage = import_language.StreamLanguage.define(dotpromptStreamParser);

// src/theme.ts
var import_language2 = require("@codemirror/language");
var import_highlight = require("@lezer/highlight");
var dotpromptDarkHighlighting = import_language2.HighlightStyle.define([
  // Comments
  { tag: import_highlight.tags.comment, color: "#6A9955", fontStyle: "italic" },
  // Keywords (if, each, etc.)
  { tag: import_highlight.tags.keyword, color: "#C586C0" },
  // Dotprompt helpers (role, json, etc.) - variable-2
  { tag: import_highlight.tags.special(import_highlight.tags.variableName), color: "#4EC9B0" },
  // Variables
  { tag: import_highlight.tags.variableName, color: "#9CDCFE" },
  // @ variables - variable-3
  { tag: import_highlight.tags.local(import_highlight.tags.variableName), color: "#4FC1FF" },
  // Strings
  { tag: import_highlight.tags.string, color: "#CE9178" },
  // Numbers
  { tag: import_highlight.tags.number, color: "#B5CEA8" },
  // Booleans and null
  { tag: import_highlight.tags.atom, color: "#569CD6" },
  // Property names (YAML keys)
  { tag: import_highlight.tags.propertyName, color: "#569CD6" },
  // Operators
  { tag: import_highlight.tags.operator, color: "#D4D4D4" },
  // Brackets/delimiters
  { tag: import_highlight.tags.bracket, color: "#DCDCAA" },
  // Meta (frontmatter delimiters)
  { tag: import_highlight.tags.meta, color: "#6A9955" }
]);
var dotpromptLightHighlighting = import_language2.HighlightStyle.define([
  // Comments
  { tag: import_highlight.tags.comment, color: "#008000", fontStyle: "italic" },
  // Keywords
  { tag: import_highlight.tags.keyword, color: "#AF00DB" },
  // Dotprompt helpers
  { tag: import_highlight.tags.special(import_highlight.tags.variableName), color: "#267F99" },
  // Variables
  { tag: import_highlight.tags.variableName, color: "#001080" },
  // @ variables
  { tag: import_highlight.tags.local(import_highlight.tags.variableName), color: "#0070C1" },
  // Strings
  { tag: import_highlight.tags.string, color: "#A31515" },
  // Numbers
  { tag: import_highlight.tags.number, color: "#098658" },
  // Booleans and null
  { tag: import_highlight.tags.atom, color: "#0000FF" },
  // Property names
  { tag: import_highlight.tags.propertyName, color: "#0000FF" },
  // Operators
  { tag: import_highlight.tags.operator, color: "#000000" },
  // Brackets
  { tag: import_highlight.tags.bracket, color: "#795E26" },
  // Meta
  { tag: import_highlight.tags.meta, color: "#008000" }
]);
var dotpromptDarkTheme = (0, import_language2.syntaxHighlighting)(dotpromptDarkHighlighting);
var dotpromptLightTheme = (0, import_language2.syntaxHighlighting)(
